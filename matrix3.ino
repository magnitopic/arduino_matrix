/*
  Muestra secuencialmente los números del 0 al 9.
  Como es un display de cuatro módulos en todos ellos
...
void mostrar_0(){     // funcion mostrar_0
  ...
  {
    lc0.setRow(0,i,cero[i]);   // establece fila con valor de array cero en misma posicion
    lc1.setRow(1,i,cero[i]);
    lc2.setRow(2,i,cero[i]);
    lc3.setRow(3,i,cero[i]);
  }
}
...
void mostrar_1(){     // funcion mostrar_1
  for (int i = 0; i < 8; i++)     // bucle itera 8 veces por el array 
  {
    lc0.setRow(0,i,uno[i]);    // establece fila con valor de array uno en misma posicion
    lc1.setRow(1,i,uno[i]);
    lc2.setRow(2,i,uno[i]);
    lc3.setRow(3,i,uno[i]);
  }
}
...
void mostrar_2(){     // funcion mostrar_2
  for (int i = 0; i < 8; i++)     // bucle itera 8 veces por el array
  {
    lc0.setRow(0,i,dos[i]);    // establece fila con valor de array dos en misma posicion
    lc1.setRow(1,i,dos[i]);
    lc2.setRow(2,i,dos[i]);
    lc3.setRow(3,i,dos[i]);
  }
}
...
void mostrar_3(){     // funcion mostrar_3
  for (int i = 0; i < 8; i++)     // bucle itera 8 veces por el array 
  {
    lc0.setRow(0,i,tres[i]);   // establece fila con valor de array tres en misma posicion
    lc1.setRow(1,i,tres[i]);
    lc2.setRow(2,i,tres[i]);
    lc3.setRow(3,i,tres[i]);
  }
}
...
void mostrar_4(){     // funcion mostrar_4
  for (int i = 0; i < 8; i++)     // bucle itera 8 veces por el array 
  {
    lc0.setRow(0,i,cuatro[i]);   // establece fila con valor de array cuatro en misma posicion
    lc1.setRow(1,i,cuatro[i]);
    lc2.setRow(2,i,cuatro[i]);
    lc3.setRow(3,i,cuatro[i]);
  }
}
...
void mostrar_5(){     // funcion mostrar_5
  for (int i = 0; i < 8; i++)     // bucle itera 8 veces por el array 
  {
    lc0.setRow(0,i,cinco[i]);    // establece fila con valor de array cinco en misma posicion
    lc1.setRow(1,i,cinco[i]);
    lc2.setRow(2,i,cinco[i]);
    lc3.setRow(3,i,cinco[i]);
  }
}
...
void mostrar_6(){     // funcion mostrar_6
  for (int i = 0; i < 8; i++)     // bucle itera 8 veces por el array 
  {
    lc0.setRow(0,i,seis[i]);   // establece fila con valor de array seis en misma posicion
    lc1.setRow(1,i,seis[i]);
    lc2.setRow(2,i,seis[i]);
    lc3.setRow(3,i,seis[i]);
  }
}
...
void mostrar_7(){     // funcion mostrar_7
  for (int i = 0; i < 8; i++)     // bucle itera 8 veces por el array 
  {
    lc0.setRow(0,i,siete[i]);    // establece fila con valor de array siete en misma posicion
    lc1.setRow(1,i,siete[i]);
    lc2.setRow(2,i,siete[i]);
    lc3.setRow(3,i,siete[i]);
  }
}
...
void mostrar_8(){     // funcion mostrar_8
  for (int i = 0; i < 8; i++)     // bucle itera 8 veces por el array 
  {
    lc0.setRow(0,i,ocho[i]);   // establece fila con valor de array ocho en misma posicion
    lc1.setRow(1,i,ocho[i]);
    lc2.setRow(2,i,ocho[i]);
    lc3.setRow(3,i,ocho[i]);
  }
}
...
void mostrar_9(){     // funcion mostrar_9
  for (int i = 0; i < 8; i++)     // bucle itera 8 veces por el array 
  {
    lc0.setRow(0,i,nueve[i]);    // establece fila con valor de array nueve en misma posicion
    lc1.setRow(1,i,nueve[i]);
    lc2.setRow(2,i,nueve[i]);
    lc3.setRow(3,i,nueve[i]);
  }
}